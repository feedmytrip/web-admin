        ...
        <div class="field">
          ...
          <div class="control">
            <input
              ...
              v-model="highlight['title'][languageCode]"
            >
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    save () {
      this.loading = true
      this.$store.dispatch('highlights/new', this.highlight)
        .then(result => {
          this.loading = false
          this.highlight = {
            filter: '',
